...
This is probably caused by illegal octal escape sequences.`),{_$litType$:i,strings:e,values:t}),g=wt(gt),T=Symbol.for("lit-noChange"),p=Symbol.for("lit-nothing"),Oe=new WeakMap,H=(i,e,t)=>{var s,n;if(e==null)throw new TypeError(`The container to render into may not be ${e}`);const o=ot++,r=(s=t==null?void 0:t.renderBefore)!==null&&s!==void 0?s:e;let c=r._$litPart$;if(d==null||d({kind:"begin render",id:o,value:i,container:e,options:t,part:c}),c===void 0){const a=(n=t==null?void 0:t.renderBefore)!==null&&n!==void 0?n:null;r._$litPart$=c=new U(e.insertBefore(R(),a),a,void 0,t!=null?t:{})}return c._$setValue(i),d==null||d({kind:"end render",id:o,value:i,container:e,options:t,part:c}),c};H.setSanitizer=at,H.createSanitizer=me,H._testOnlyClearSanitizerFactoryDoNotCallOrElse=dt;const E=O.createTreeWalker(O,129,null,!1);let S=B;const $t=(i,e)=>{const t=i.length-1,s=[];let n=e===ge?"<svg>":"",o,r=N;for(let a=0;a<t;a++){const l=i[a];let f=-1,m,h=0,u;for(;h<l.length&&(r.lastIndex=h,u=r.exec(l),u!==null);)if(h=r.lastIndex,r===N){if(u[Ee]==="!--")r=Ce;else if(u[Ee]!==void 0)r=Ae;else if(u[se]!==void 0)Ge.test(u[se])&&(o=new RegExp(`</${u[se]}`,"g")),r=x;else if(u[pt]!==void 0)throw new Error("Bindings in tag names are not supported. Please use static templates instead. See https://lit.dev/docs/templates/expressions/#static-expressions")}else r===x?u[mt]===">"?(r=o!=null?o:N,f=-1):u[ke]===void 0?f=-2:(f=r.lastIndex-u[ft].length,m=u[ke],r=u[Ne]===void 0?x:u[Ne]==='"'?oe:ne):r===oe||r===ne?r=x:r===Ce||r===Ae?r=N:(r=x,o=void 0);console.assert(f===-1||r===x||r===ne||r===oe,"unexpected parse state B");const F=r===x&&i[a+1].startsWith("/>")?" ":"";n+=r===N?l+lt:f>=0?(s.push(m),l.slice(0,f)+fe+l.slice(f)+b+F):l+b+(f===-2?(s.push(void 0),a):F)}const c=n+(i[t]||"<?>")+(e===ge?"</svg>":"");if(!Array.isArray(i)||!i.hasOwnProperty("raw")){let a="invalid template strings array";throw a=`
        ...
        `.trim().replace(/\n */g,`
`),new Error(a)}return[Se!==void 0?Se.createHTML(c):c,s]};class M{constructor({strings:e,["_$litType$"]:t},s){this.parts=[];let n,o=0,r=0;const c=e.length-1,a=this.parts,[l,f]=$t(e,t);if(this.el=M.createElement(l,s),E.currentNode=this.el.content,t===ge){const m=this.el.content,h=m.firstChild;h.remove(),m.append(...h.childNodes)}for(;(n=E.nextNode())!==null&&a.length<c;){if(n.nodeType===1){{const m=n.localName;if(/^(?:textarea|template)$/i.test(m)&&n.innerHTML.includes(b)){const h=`Expressions are not supported inside \`${m}\` elements. See https://lit.dev/msg/expression-in-${m} for more information.`;if(m==="template")throw new Error(h);D("",h)}}if(n.hasAttributes()){const m=[];for(const h of n.getAttributeNames())if(h.endsWith(fe)||h.startsWith(b)){const u=f[r++];if(m.push(h),u!==void 0){const Ze=n.getAttribute(u.toLowerCase()+fe).split(b),j=/([.?@])?(.*)/.exec(u);a.push({type:ve,index:o,name:j[2],strings:Ze,ctor:j[1]==="."?xt:j[1]==="?"?St:j[1]==="@"?Et:W})}else a.push({type:be,index:o})}for(const h of m)n.removeAttribute(h)}if(Ge.test(n.tagName)){const m=n.textContent.split(b),h=m.length-1;if(h>0){n.textContent=C?C.emptyScript:"";for(let u=0;u<h;u++)n.append(m[u],R()),E.nextNode(),a.push({type:V,index:++o});n.append(m[h],R())}}}else if(n.nodeType===8)if(n.data===Qe)a.push({type:V,index:o});else{let h=-1;for(;(h=n.data.indexOf(b,h+1))!==-1;)a.push({type:bt,index:o}),h+=b.length-1}o++}d==null||d({kind:"template prep",template:this,clonableTemplate:this.el,parts:this.parts,strings:e})}static createElement(e,t){const s=O.createElement("template");return s.innerHTML=e,s}}function A(i,e,t=i,s){var n,o,r,c;if(e===T)return e;let a=s!==void 0?(n=t.__directives)===null||n===void 0?void 0:n[s]:t.__directive;const l=L(e)?void 0:e._$litDirective$;return(a==null?void 0:a.constructor)!==l&&((o=a==null?void 0:a._$notifyDirectiveConnectionChanged)===null||o===void 0||o.call(a,!1),l===void 0?a=void 0:(a=new l(i),a._$initialize(i,t,s)),s!==void 0?((r=(c=t).__directives)!==null&&r!==void 0?r:c.__directives=[])[s]=a:t.__directive=a),a!==void 0&&(e=A(i,a._$resolve(i,e.values),a,s)),e}class Pt{constructor(e,t){this._parts=[],this._$disconnectableChildren=void 0,this._$template=e,this._$parent=t}get parentNode(){return this._$parent.parentNode}get _$isConnected(){return this._$parent._$isConnected}_clone(e){var t;const{el:{content:s},parts:n}=this._$template,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:O).importNode(s,!0);E.currentNode=o;let r=E.nextNode(),c=0,a=0,l=n[0];for(;l!==void 0;){if(c===l.index){let f;l.type===V?f=new U(r,r.nextSibling,this,e):l.type===ve?f=new l.ctor(r,l.name,l.strings,this,e):l.type===be&&(f=new Ct(r,this,e)),this._parts.push(f),l=n[++a]}c!==(l==null?void 0:l.index)&&(r=E.nextNode(),c++)}return o}_update(e){let t=0;for(const s of this._parts)s!==void 0&&(d==null||d({kind:"set part",part:s,value:e[t],valueIndex:t,values:e,templateInstance:this}),s.strings!==void 0?(s._$setValue(e,s,t),t+=s.strings.length-2):s._$setValue(e[t])),t++}}class U{constructor(e,t,s,n){var o;this.type=V,this._$committedValue=p,this._$disconnectableChildren=void 0,this._$startNode=e,this._$endNode=t,this._$parent=s,this.options=n,this.__isConnected=(o=n==null?void 0:n.isConnected)!==null&&o!==void 0?o:!0,this._textSanitizer=void 0}get _$isConnected(){var e,t;return(t=(e=this._$parent)===null||e===void 0?void 0:e._$isConnected)!==null&&t!==void 0?t:this.__isConnected}get parentNode(){let e=y(this._$startNode).parentNode;const t=this._$parent;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$startNode}get endNode(){return this._$endNode}_$setValue(e,t=this){if(this.parentNode===null)throw new Error("This `ChildPart` has no `parentNode` and therefore cannot accept a value. This likely means the element containing the part was manipulated in an unsupported way outside of Lit's control such that the part's marker nodes were ejected from DOM. For example, setting the element's `innerHTML` or `textContent` can do this.");e=A(this,e,t),L(e)?e===p||e==null||e===""?(this._$committedValue!==p&&(d==null||d({kind:"commit nothing to child",start:this._$startNode,end:this._$endNode,parent:this._$parent,options:this.options}),this._$clear()),this._$committedValue=p):e!==this._$committedValue&&e!==T&&this._commitText(e):e._$litType$!==void 0?this._commitTemplateResult(e):e.nodeType!==void 0?this._commitNode(e):ct(e)?this._commitIterable(e):this._commitText(e)}_insert(e,t=this._$endNode){return y(y(this._$startNode).parentNode).insertBefore(e,t)}_commitNode(e){var t;if(this._$committedValue!==e){if(this._$clear(),S!==B){const s=(t=this._$startNode.parentNode)===null||t===void 0?void 0:t.nodeName;if(s==="STYLE"||s==="SCRIPT"){let n="Forbidden";throw s==="STYLE"?n="Lit does not support binding inside style nodes. This is a security risk, as style injection attacks can exfiltrate data and spoof UIs. Consider instead using css`...` literals to compose styles, and make do dynamic styling with css custom properties, ::parts, <slot>s, and by mutating the DOM rather than stylesheets.":n="Lit does not support binding inside script nodes. This is a security risk, as it could allow arbitrary code execution.",new Error(n)}}d==null||d({kind:"commit node",start:this._$startNode,parent:this._$parent,value:e,options:this.options}),this._$committedValue=this._insert(e)}}_commitText(e){if(this._$committedValue!==p&&L(this._$committedValue)){const t=y(this._$startNode).nextSibling;this._textSanitizer===void 0&&(this._textSanitizer=me(t,"data","property")),e=this._textSanitizer(e),d==null||d({kind:"commit text",node:t,value:e,options:this.options}),t.data=e}else{const t=document.createTextNode("");this._commitNode(t),this._textSanitizer===void 0&&(this._textSanitizer=me(t,"data","property")),e=this._textSanitizer(e),d==null||d({kind:"commit text",node:t,value:e,options:this.options}),t.data=e}this._$committedValue=e}_commitTemplateResult(e){var t;const{values:s,["_$litType$"]:n}=e,o=typeof n=="number"?this._$getTemplate(e):(n.el===void 0&&(n.el=M.createElement(n.h,this.options)),n);if(((t=this._$committedValue)===null||t===void 0?void 0:t._$template)===o)d==null||d({kind:"template updating",template:o,instance:this._$committedValue,parts:this._$committedValue._parts,options:this.options,values:s}),this._$committedValue._update(s);else{const r=new Pt(o,this),c=r._clone(this.options);d==null||d({kind:"template instantiated",template:o,instance:r,parts:r._parts,options:this.options,fragment:c,values:s}),r._update(s),d==null||d({kind:"template instantiated and updated",template:o,instance:r,parts:r._parts,options:this.options,fragment:c,values:s}),this._commitNode(c),this._$committedValue=r}}_$getTemplate(e){let t=Oe.get(e.strings);return t===void 0&&Oe.set(e.strings,t=new M(e)),t}_commitIterable(e){Xe(this._$committedValue)||(this._$committedValue=[],this._$clear());const t=this._$committedValue;let s=0,n;for(const o of e)s===t.length?t.push(n=new U(this._insert(R()),this._insert(R()),this,this.options)):n=t[s],n._$setValue(o),s++;s<t.length&&(this._$clear(n&&y(n._$endNode).nextSibling,s),t.length=s)}_$clear(e=y(this._$startNode).nextSibling,t){var s;for((s=this._$notifyConnectionChanged)===null||s===void 0||s.call(this,!1,!0,t);e&&e!==this._$endNode;){const n=y(e).nextSibling;y(e).remove(),e=n}}setConnected(e){var t;if(this._$parent===void 0)this.__isConnected=e,(t=this._$notifyConnectionChanged)===null||t===void 0||t.call(this,e);else throw new Error("part.setConnected() may only be called on a RootPart returned from render().")}}class W{constructor(e,t,s,n,o){this.type=ve,this._$committedValue=p,this._$disconnectableChildren=void 0,this.element=e,this.name=t,this._$parent=n,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$committedValue=new Array(s.length-1).fill(new String),this.strings=s):this._$committedValue=p,this._sanitizer=void 0}get tagName(){return this.element.tagName}get _$isConnected(){return this._$parent._$isConnected}_$setValue(e,t=this,s,n){const o=this.strings;let r=!1;if(o===void 0)e=A(this,e,t,0),r=!L(e)||e!==this._$committedValue&&e!==T,r&&(this._$committedValue=e);else{const c=e;e=o[0];let a,l;for(a=0;a<o.length-1;a++)l=A(this,c[s+a],t,a),l===T&&(l=this._$committedValue[a]),r||(r=!L(l)||l!==this._$committedValue[a]),l===p?e=p:e!==p&&(e+=(l!=null?l:"")+o[a+1]),this._$committedValue[a]=l}r&&!n&&this._commitValue(e)}_commitValue(e){e===p?y(this.element).removeAttribute(this.name):(this._sanitizer===void 0&&(this._sanitizer=S(this.element,this.name,"attribute")),e=this._sanitizer(e!=null?e:""),d==null||d({kind:"commit attribute",element:this.element,name:this.name,value:e,options:this.options}),y(this.element).setAttribute(this.name,e!=null?e:""))}}class xt extends W{constructor(){super(...arguments),this.type=_t}_commitValue(e){this._sanitizer===void 0&&(this._sanitizer=S(this.element,this.name,"property")),e=this._sanitizer(e),d==null||d({kind:"commit property",element:this.element,name:this.name,value:e,options:this.options}),this.element[this.name]=e===p?void 0:e}}const Tt=C?C.emptyScript:"";class St extends W{constructor(){super(...arguments),this.type=yt}_commitValue(e){d==null||d({kind:"commit boolean attribute",element:this.element,name:this.name,value:!!(e&&e!==p),options:this.options}),e&&e!==p?y(this.element).setAttribute(this.name,Tt):y(this.element).removeAttribute(this.name)}}class Et extends W{constructor(e,t,s,n,o){if(super(e,t,s,n,o),this.type=vt,this.strings!==void 0)throw new Error(`A \`<${e.localName}>\` has a \`@${t}=...\` listener with invalid content. Event listeners in templates must have exactly one expression and no surrounding text.`)}_$setValue(e,t=this){var s;if(e=(s=A(this,e,t,0))!==null&&s!==void 0?s:p,e===T)return;const n=this._$committedValue,o=e===p&&n!==p||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,r=e!==p&&(n===p||o);d==null||d({kind:"commit event listener",element:this.element,name:this.name,value:e,options:this.options,removeListener:o,addListener:r,oldListener:n}),o&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,e),this._$committedValue=e}handleEvent(e){var t,s;typeof this._$committedValue=="function"?this._$committedValue.call((s=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&s!==void 0?s:this.element,e):this._$committedValue.handleEvent(e)}}class Ct{constructor(e,t,s){this.element=e,this.type=be,this._$disconnectableChildren=void 0,this._$parent=t,this.options=s}get _$isConnected(){return this._$parent._$isConnected}_$setValue(e){d==null||d({kind:"commit to element binding",element:this.element,value:e,options:this.options}),A(this,e)}}const re=window.litHtmlPolyfillSupportDevMode;re==null||re(M,U);((te=globalThis.litHtmlVersions)!==null&&te!==void 0?te:globalThis.litHtmlVersions=[]).push("2.2.6");globalThis.litHtmlVersions.length>1&&D("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const At=(i,e)=>(window.customElements.define(i,e),e),kt=(i,e)=>{const{kind:t,elements:s}=e;return{kind:t,elements:s,finisher(n){window.customElements.define(i,n)}}},w=i=>e=>typeof e=="function"?At(i,e):kt(i,e);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Nt=(i,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,i)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,i)}},Ot=(i,e,t)=>{e.constructor.createProperty(t,i)};function q(i){return(e,t)=>t!==void 0?Ot(i,e,t):Nt(i,e)}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var he;((he=window.HTMLSlotElement)===null||he===void 0?void 0:he.prototype.assignedElements)!=null;var Rt=Object.defineProperty,Lt=Object.getOwnPropertyDescriptor,Mt=(i,e,t,s)=>{for(var n=s>1?void 0:s?Lt(e,t):e,o=i.length-1,r;o>=0;o--)(r=i[o])&&(n=(s?r(e,t,n):r(n))||n);return s&&n&&Rt(e,t,n),n};let Ut=(i,e)=>{let t=0;i.forEach(s=>{s.isIntersecting&&(setTimeout(()=>{s.target.show()},t*100),t++)})};const It=new IntersectionObserver(Ut,{rootMargin:"-100px"});let Re=class extends _{static get styles(){return P`
      :host {
        display: block;
    ...
    `}};Re=Mt([w("nida-card")],Re);var jt=Object.defineProperty,zt=Object.getOwnPropertyDescriptor,I=(i,e,t,s)=>{for(var n=s>1?void 0:s?zt(e,t):e,o=i.length-1,r;o>=0;o--)(r=i[o])&&(n=(s?r(e,t,n):r(n))||n);return s&&n&&jt(e,t,n),n};let k=class extends _{constructor(){super(),this._image=new Image,this._image.addEventListener("load",()=>{setTimeout(()=>{this._image.classList.remove("hidden")},10)})}static get styles(){return P`
			:host {
				display: contents;
			}
		...
		`}connectedCallback(){super.connectedCallback()}attributeChangedCallback(i,e,t){super.attributeChangedCallback(i,e,t),i==="src"&&(this._image.src=t,this._image.width=+(this.width||0),this._image.height=+(this.height||0),this._image.loading="lazy",this._image.alt=this.alt||"",this._image.classList.add("hidden"))}render(){return g`${this._image}`}};I([q({type:String})],k.prototype,"src",2);I([q({type:String})],k.prototype,"alt",2);I([q({type:String})],k.prototype,"width",2);I([q({type:String})],k.prototype,"height",2);k=I([w("aui-lazyimage")],k);var Ht=Object.defineProperty,Dt=Object.getOwnPropertyDescriptor,Vt=(i,e,t,s)=>{for(var n=s>1?void 0:s?Dt(e,t):e,o=i.length-1,r;o>=0;o--)(r=i[o])&&(n=(s?r(e,t,n):r(n))||n);return s&&n&&Ht(e,t,n),n};let Le=class extends _{constructor(){super(...arguments),this.cards=[],this.init=!1}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),window.addEventListener("cards",e=>{this.cards=e.detail});const i=document.querySelector(".page");if(i)i.addEventListener("scroll",()=>{!this.init&&this.cards.length>0&&(this.init=!0,this.requestUpdate())});else throw new Error("Something went wrong")}renderMedia(i){switch(i.type){default:return i.embed?g`<iframe
            src="${i.embed}"
            width="100%"
            height="280px"
            style="border: none;"
    ...
    `}};Le=Vt([w("nida-cardlist")],Le);const Bt=["aethia1Blankie AETHY BIRTHDAY! aethia1Blankie aethia1Blankie AETHY BIRTHDAY! aethia1Blankie","When's your birthday Aethy? Is it this year?","aethia1Sing aethia1Sing aethia1Sing ","aethia1Pats aethia1Like aethia1Pats","aethia1Flower aethia1Flower aethia1Flower aethia1Flower","aethia1Hype aethia1Hype aethia1Hype aethia1Hype aethia1Hype","Quit job this year?","aethia1Laugh aethia1Laugh","aethia1Wow aethia1Hug aethia1Wow"];var Wt=Object.defineProperty,qt=Object.getOwnPropertyDescriptor,Ft=(i,e,t,s)=>{for(var n=s>1?void 0:s?qt(e,t):e,o=i.length-1,r;o>=0;o--)(r=i[o])&&(n=(s?r(e,t,n):r(n))||n);return s&&n&&Wt(e,t,n),n};let Me=class extends _{constructor(){super(...arguments),this.messages=[]}static get styles(){return P`
      :host {
        display: block;
        position: absolute;
        bottom: 120px;
    ...
    `}};Me=Ft([w("nida-chat")],Me);var Kt=Object.defineProperty,Yt=Object.getOwnPropertyDescriptor,Qt=(i,e,t,s)=>{for(var n=s>1?void 0:s?Yt(e,t):e,o=i.length-1,r;o>=0;o--)(r=i[o])&&(n=(s?r(e,t,n):r(n))||n);return s&&n&&Kt(e,t,n),n};let Ue=class extends _{constructor(i){super(),this.original=i,this.position=null}static get styles(){return P`
      :host {
        position: fixed;
        top: 0;
        left: 0;
...
`).split(" "),s=[];for(let n of t)if(n=n.replace(/:/g,""),n in He)s.push(`<span class="emote"><img src="${He[n]}" alt="${n}" /></span>`);else{let o=n;for(let r of di(n))o=o.replace(r[0],`<span class="emote">${r[0]}</span>`);s.push(o)}this.content=s.join(" "),this.requestUpdate()}render(){return g`
    ...
    `}};De=ai([w("nida-message")],De);var li=Object.defineProperty,ci=Object.getOwnPropertyDescriptor,hi=(i,e,t,s)=>{for(var n=s>1?void 0:s?ci(e,t):e,o=i.length-1,r;o>=0;o--)(r=i[o])&&(n=(s?r(e,t,n):r(n))||n);return s&&n&&li(e,t,n),n};let Ve=class extends _{static get styles(){return P`
      :host {
        position: fixed;
        bottom: 40px;
        left: 50%;
    ...
    `}};Ve=hi([w("scroll-indicator")],Ve);var ui=Object.defineProperty,pi=Object.getOwnPropertyDescriptor,mi=(i,e,t,s)=>{for(var n=s>1?void 0:s?pi(e,t):e,o=i.length-1,r;o>=0;o--)(r=i[o])&&(n=(s?r(e,t,n):r(n))||n);return s&&n&&ui(e,t,n),n};async function fi(i){return new Promise(e=>{setTimeout(()=>{e(1)},i)})}let Be=class extends _{constructor(){super(...arguments),this.content=[],this.lastData=null}static get styles(){return P`
      :host {
        display: contents;
      }
